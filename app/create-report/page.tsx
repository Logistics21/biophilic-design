...
export default function CreateReportPage() {
  ...
  return (
    <div className="flex h-fit w-screen items-center justify-center bg-gray-50 py-5">
      <div className="z-10 w-full max-w-3xl overflow-hidden rounded-2xl border shadow-xl">
        <div className="flex flex-col items-left justify-center space-y-3 border-b bg-white px-4 py-6 pt-8 text-left sm:px-16">
